...
public class CourseDAO {
    ...
    public int getCourseCountByDate(int userId, int dayOfWeek, int weekNumber) {
        String sql = "SELECT COUNT(*) FROM courses WHERE user_id = ? AND day_of_week = ? AND ? BETWEEN week_start AND week_end";
     ...
     * 获取当前周次的活跃课程数量
     */
    public int getActiveCoursesCount(int userId, int currentWeek) {
        String sql = "SELECT COUNT(*) FROM courses WHERE user_id = ? AND ? BETWEEN week_start AND week_end";
